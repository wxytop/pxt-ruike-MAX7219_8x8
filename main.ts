...
namespace max7219_matrix {
    ...
    */
    //% block="初始化MAX7219:|点阵屏数 $num|CS(LOAD) = $cs|MOSI(DIN) = $mosi|MISO(not used) = $miso|SCK(CLK) = $sck"
    ...
    */
    //% block="滚动显示文本 $text|延时 (ms) $delay|结束后暂停时间 (ms) $endDelay" text.defl="Hello world!" delay.min=0 delay.defl=75 endDelay.min=0 endDelay.defl=500 group="2. Display text on matrixs" blockExternalInputs=true
    ...
    */
    //% block="显示文本 (左对齐) $text|offset $offset|先清除屏幕 $clear" text.defl="Hi!" offset.min=-8 clear.defl=true group="2. Display text on matrixs" blockExternalInputs=true
    ...
    */
    //% block="显示文本 (右对齐) $text|先清除屏幕 $clear" text.defl="Hi!" clear.defl=true group="2. Display text on matrixs" blockExternalInputs=true
    ...
    */
    //% block="设置灯光亮度 $level" level.min=0 level.max=15 level.defl=15 group="3. Basic light control"
    ...
    */
    //% block="显示所有灯" group="3. Basic light control"
    ...
    */
    //% block="清除所有显示" group="3. Basic light control"
    ...
    */
    //% block="随机显示点阵屏" index.min=0 group="3. Basic light control"
